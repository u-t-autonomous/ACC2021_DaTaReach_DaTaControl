...
def canApproximate(overApprox):
    """ Check if the differential inclusion is a finite set
    """
...
def nextStateOverApprox(b_lb, b_ub, A1_lb, A1_ub, A2_lb, A2_ub, uVal):
    """ Over-approximate the next state of the system given the intervals matrices
        ad vector A1, A2; b, and the applied control uVal
    """
...
def controlAffineOverApprox(overApprox, x0, dt, uOver_lb, uOver_ub,
            ...
            gronwallCoeff=-1):
    """ Compute a control affine linearizaton of the reachable set of the system
    """
    dt_2 = 0.5 * dt**2
